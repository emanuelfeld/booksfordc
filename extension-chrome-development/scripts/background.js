(function () {
  ...
  window.browser.runtime.onInstalled.addListener(function (details) {
    ...
    //     'url': `https://booksfordc.org/welcome-chrome?utm_source=chrome&utm_campaign=install&version=` + version
    //   })
    //   window.browser.tabs.create({
    //     'url': `https://booksfordc.org/update?utm_source=chrome&utm_campaign=update&version=` + version
    //   })      
  ...
  window.browser.runtime.setUninstallURL(`http://bit.ly/bfdc-chrome`)  
})()
