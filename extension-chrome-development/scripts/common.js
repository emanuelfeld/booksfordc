(function () {
  ...
  console.log(`SETUP: using chrome`)
    ...
    initializeLayout: function () {
      ...
      let pluginBox = `<div id='bfdc-${this.extension.site}' class='bfdc-container'>
                         ...
                         <div class='bfdc-availability'>
                            <div class='bfdc-title'>
                                <a href = 'https://booksfordc.org?utm_source=chrome&utm_campaign=${this.extension.site}' target='_blank'>
                                  booksfordc
                                </a>
                            </div>
                         </div>
      ...
      if (this.extension.mediaTypes.length) {
        ...
        $('div.bfdc-media:last-child').after(
            ...
            <div class='bfdc-media bfdc-footer'>
              <a href='https://booksfordc.herokuapp.com/contribute?utm_source=chrome&utm_campaign=${this.extension.site}' target='_blank'>
                donate
              </a>
            </div>`
        )
